...
const style = {
  ...
  pHead: {paddingTop: '15px', margin: '0 auto', fontSize: '1.4em', color: 'white', fontWeight: 'lighter', letterSpacing: '3px'}
}
...
class DashboardHeader extends Component {
  render() {
    return(
      <Paper id='customFade1s' className="animated fadeInDown" style={style.paperHeader} zDepth={0} rounded={false}>
      <header className='dashboard-header'>
        <div id="myTopnav dashboard-nav">
        <Paper zDepth={1} style={style.paperHead} rounded={false}><p style={style.pHead}>Baykoo</p></Paper>
